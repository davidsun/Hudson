...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('sns_post', 'image_link',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Post.video_link'
        db.add_column('sns_post', 'video_link',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('sns_post', 'image_link')

        # Deleting field 'Post.video_link'
        db.delete_column('sns_post', 'video_link')
