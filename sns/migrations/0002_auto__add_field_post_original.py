...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.original'
        db.add_column('sns_post', 'original',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sns.Post'], null=True, on_delete=models.SET_NULL),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.original'
        db.delete_column('sns_post', 'original_id')
    ...
    models = {
        ...
        'sns.post': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'original': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sns.Post']", 'null': 'True', 'on_delete': 'models.SET_NULL'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
